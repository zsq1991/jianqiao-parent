    ...
    function table_add(num,countNum) {
        ...
        for (var k = 0; k < tmpc.length; k++) {
            ...
            str +=
                ...
                '<td class="td_input"><input type="text" class="table_input validate[required,custom[price], min[0]]" ref="skus"  name="platfromIncome" id="'+platfID+'" onblur="setPlatfromIncome('+k+',\'' +platfID+'\');" value="" /></td>' +
